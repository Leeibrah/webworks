...
<div class="social_media_box">
    <a href="http://facebook.com/trascope" target="_blank" onclick="add_to_faves('facebook')"><div class="sprites" id="facebook_png"><img src="img/facebook_icon.png" /></div></a>
    <a href="http://twitter.com/trascope" target="_blank" onclick="add_to_faves('twitter')"><div class="sprites" id="twitter_png"><img src="img/twitter_icon.png" /></div></a>
</div>
  <div id="container">
    <header>
		<div id="logo">
    ...
    <div id="main" role="main">
			...
			<a href="http://Trascope.com"><img src="img/slider/slider_1.png" alt="" ></a>
				<img src="img/slider/slider_5.png" alt="" >
                <a href="http://Trascope.com"><img src="img/slider/slider_1.png" alt=""></a>
                <img src="img/slider/slider_3.png" alt="" data-transition="slideInLeft" >
	...
	<div class="bottom_section">
		...
		<span>Our Clients</span>
			<div class="box">
				<ul id="logos">
					<li><a href="http://www.trascope.com"><div id="logo"><img src="img/logo.png"/></div></a></li>
					<li><a href="http://www.trascope.com"><div id="logo"><img src="img/logo.png"/></div></a></li>
					<li><a href="http://www.trascope.com"><div id="logo"></div></a></li>
					<li><a href="http://www.trascope.com"><div id="logo"></div></a></li>
				</ul>
				</div>
			</div>
		...
		<div class="column2" style="margin-left:10px;">
			...
			<div class="box">
			<p>
			Trascope is a visionary firm that leverages on technologies such as, <b>Web Design, USSD</b>, <b>Mobile Web</b>, and <b>SMS</b> to provide order management, distribution, tracking, circulation and validation solutions. Trascope also offers reliable customer service, support and maintenance to its clients.
			</p>
				</div>
			</div>
